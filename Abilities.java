/**
 * Contains the methods to create ability card objects and manipulate them
 *
...
public class Abilities
{
    ...
    /**
     * Creates an ability card object
     * Used to create an ambiguous ability card object
     * 
     */
    public Abilities(){
    }
    ...
    /**
     * Completes a ability card object, filling in the remaining attributes given the ability name and playNum
     * 
     * @param cardName - The name of the ability whose stats will be entered into the card object
     * @param playNum - The playNum of the object
     */
    public void playCard(String cardName, int playNum){
        
        String query = "{ call getAbilityByName(?) }";
        ResultSet rs;
    ...
    /**
     * Returns the stats of a ability card object in a formatted manner
     * 
     * @return - The stats of the ability card object
     */
    ...
    public static void printStatsByName(String Name) { 
        ...
        try (Connection conn = MySQLJDBCUtil.getConnection(); //Create a connection
            ...
            rs = stmt.executeQuery(); // Execute Statement
            while (rs.next()) {
                System.out.print("Ability: " + rs.getString("card_name") + "\n" + 
                ...
                System.out.println("Effect: " + rs.getString("effect") + "\n" +
                                    "Spell Speed: " + rs.getString("spell_speed") + "\n" +
    ...
    public static void printListByRegion(String Region) {
        String query = "{ call getAbilitiesByRegion(?) }";
        ...
        try (Connection conn = MySQLJDBCUtil.getConnection(); //Create a connection
            ...
            rs = stmt.executeQuery(); // Execute Statement
            while (rs.next()) {
                System.out.println("Ability: " + rs.getString("card_name") + "\n" + 
                                    "Region(s): " + rs.getString("region_1")
                                    );
                                        if(rs.getString("region_2") == "") { 
                                            System.out.print("\n");
    ...
    public static void printListByRarity(String Rarity) {
        ...
        String query = "{ call getAbilitiesByRarity(?) }";
    ...
    public static void printListByArtist(String Artist) {
        ...
        String query = "{ call getAbilitiesByArtistName(?) }";
