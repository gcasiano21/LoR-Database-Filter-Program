/**
 * Contains the methods to create champion card objects and manipulate them
 *
...
public class Champions
{
    ...
    /**
     * Creates a champion card object
     * Used to create an ambiguous champion card object
     * 
     */
    public Champions(){
    }
    ...
    /**
     * Completes a champions card object, filling in the remaining attributes given the champion name and playNum
     * 
     * @param cardName - The name of the champion whose stats will be entered into the card object
     * @param playNum - The playNum of the object
     */
    public void playCard(String cardName, int playNum){
        
        String query = "{ call getChampionByName(?) }";
        ResultSet rs;
        ...
        try (Connection conn = MySQLJDBCUtil.getConnection(); //Create a connection
            ...
            while (rs.next()) {
                ...
                this.levelUp = rs.getString("level_up_description");
    ...
    /**
     * Returns the stats of a champion card object in a formatted manner
     * 
     * @return - The stats of the champion card object
     */
    ...
    public static void printStatsByName(String Name) { 
        ...
        try (Connection conn = MySQLJDBCUtil.getConnection(); //Create a connection
            ...
            rs = stmt.executeQuery(); // Execute Statement
            while (rs.next()) {
                System.out.print("Champion: " + rs.getString("card_name") + "\n" + 
                ...
                System.out.println("Attack: " + rs.getInt("attack") + "\n" +
                                    ...
                                    "Level-Up Description: " + rs.getString("level_up_description") + "\n" +
    ...
    public static void printListByRegion(String Name){
        String query = "{ call getChampionsByRegion(?) }";
        ...
        try (Connection conn = MySQLJDBCUtil.getConnection(); //Create a connection
            ...
            rs = stmt.executeQuery(); // Execute Statement
            while (rs.next()) {
                System.out.println("Champion: " + rs.getString("card_name") + "\n" + 
                                    "Region(s): " + rs.getString("region_1")
                                    );
                                        if(rs.getString("region_2") == "") { 
                                            System.out.print("\n");
    ...
    public static void printListByRarity(String Rarity) {
        ...
        String query = "{ call getChampionsByRarity(?) }";
    ...
    public static void printListByArtist(String Artist) {
        ...
        String query = "{ call getChampionsByArtistName(?) }";
